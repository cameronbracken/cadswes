...
D = abs(pDW[, 2] - Flow)  #calculates difference between selected flow and other observed flows
Delta = cbind(pDW[, 1], D)  #combines difference and corresponding year into one matrix
